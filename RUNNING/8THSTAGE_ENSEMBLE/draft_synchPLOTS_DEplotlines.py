...
for w in range(2,6):
    ...
    for n in range(1,run+1):
        ...
        if M == 2:
            if n == run:
                cc = color[0]
                plt.plot(SEplot,''+str(cc)+'-',label='$D_E$='+str(M)+'') 
                l1, = plt.plot(SEplot,''+str(cc)+'-',label='$D_E$='+str(M)+'') 
                plt.yscale('log')
                plt.xlim(1,run)
            ...
            if n == run:
                cc = color[1]
                plt.plot(SEplot,''+str(cc)+'-',label='$D_E$='+str(M)+'') 
                l2, = plt.plot(SEplot,''+str(cc)+'-',label='$D_E$='+str(M)+'') 
                plt.yscale('log')
                plt.xlim(1,run)
            ...
            if n == run:
                cc = color[2]
                plt.plot(SEplot,''+str(cc)+'-',label='$D_E$='+str(M)+'') 
                l3, = plt.plot(SEplot,''+str(cc)+'-',label='$D_E$='+str(M)+'') 
                plt.yscale('log')
                plt.xlim(1,run)
            ...
            if n == run:
                cc = color[3]
                plt.plot(SEplot,''+str(cc)+'-',label='$D_E$='+str(M)+'') 
                l4, = plt.plot(SEplot,''+str(cc)+'-',label='$D_E$='+str(M)+'') 
                plt.yscale('log')
                plt.xlim(1,run)
