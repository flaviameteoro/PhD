...
gtau1 = 0.2#1.0#0.9#2./3.        For increasing nudging = 0.1, for decreasing = 0.9         # Factor to be applied to the pseudoinv used in the 1st unobserved time step after an observation 
gtau_ini = 0.2

gtau_adj = 0.25                   #For adjusting gtau if lya > 1
gtau_adj2 = 0.15
...
#            tick.set_fontsize(15)
        ...
        if n > 50:
            if leadinglya > 0:    
                #if leadinglya < 0.00025:       
                if n < 1540:     
                    gtau1 = gtau_adj
                    #print 'Adjusting gtau...'
                else:
                    gtau1 = gtau_adj2
                print 'lya=', leadinglya
            else:
                gtau1 = gtau_ini
