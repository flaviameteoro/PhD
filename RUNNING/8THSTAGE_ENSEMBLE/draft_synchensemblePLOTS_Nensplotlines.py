...
for w in Nens_list:
    ...
    for n in range(1,run+1):
        ...
        if Nens == Nens_list[0]:
            if n == run:
                cc = color[0]
                plt.plot(SEplot,''+str(cc)+'-',label='Nens='+str(Nens)+'') 
                l1, = plt.plot(SEplot,''+str(cc)+'-',label='Nens='+str(Nens)+'') 
                plt.yscale('log')
                plt.xlim(1,run)
            ...
            if n == run:
                cc = color[1]
                plt.plot(SEplot,''+str(cc)+'-',label='Nens='+str(Nens)+'') 
                l2, = plt.plot(SEplot,''+str(cc)+'-',label='Nens='+str(Nens)+'') 
                plt.yscale('log')
                plt.xlim(1,run)
            ...
            if n == run:
                cc = color[2]
                plt.plot(SEplot,''+str(cc)+'-',label='Nens='+str(Nens)+'') 
                l3, = plt.plot(SEplot,''+str(cc)+'-',label='Nens='+str(Nens)+'') 
                plt.yscale('log')
                plt.xlim(1,run)
            ...
            if n == run:
                cc = color[3]
                plt.plot(SEplot,''+str(cc)+'-',label='Nens='+str(Nens)+'') 
                l4, = plt.plot(SEplot,''+str(cc)+'-',label='Nens='+str(Nens)+'') 
                plt.yscale('log')
                plt.xlim(1,run)
