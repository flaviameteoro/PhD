...
for w in sigma_list:
    ...
    for n in range(1,run+1):
        ...
        ######### Calculating the Synchronisation Error (SE) ##################
        dd = np.zeros([D,1])
        ...
        if sigma == sigma_list[0]:
            if n == run:
                cc = color[0]
                plt.plot(SEplot,''+str(cc)+'-',label='$\sigma_o$='+str(sigma)+'') 
                l1, = plt.plot(SEplot,''+str(cc)+'-',label='$\sigma_o$='+str(sigma)+'') 
                plt.yscale('log')
                plt.xlim(1,run)
            ...
            if n == run:
                cc = color[1]
                plt.plot(SEplot,''+str(cc)+'-',label='$\sigma_o$='+str(sigma)+'') 
                l2, = plt.plot(SEplot,''+str(cc)+'-',label='$\sigma_o$='+str(sigma)+'') 
                plt.yscale('log')
                plt.xlim(1,run)


        #elif sigma == sigma_list[2]:
            #if n == run:
                #cc = color[2]
                #plt.plot(SEplot,''+str(cc)+'-',label='$\sigma_o$='+str(sigma)+'') 
                #l3, = plt.plot(SEplot,''+str(cc)+'-',label='$\sigma_o$='+str(sigma)+'') 
                #plt.yscale('log')
                #plt.xlim(1,run)
            ...
            if n == run:
                ...
                plt.plot(SEplot,''+str(cc)+'-',label='$\sigma_o$='+str(sigma)+'') 
                l3, = plt.plot(SEplot,''+str(cc)+'-',label='$\sigma_o$='+str(sigma)+'') 
                #l4, = plt.plot(SEplot,''+str(cc)+'-',label='$\sigma_o$='+str(sigma)+'') 
                plt.yscale('log')
                plt.xlim(1,run)
