...
for w in Nens_list:
    ...
    K_new = 1.e1*np.diag(np.ones([Nens])) 
    ...
    for n in range(1,run+1):
        ...
        if Nens == Nens_list[0]:
            ...
            if n == run:
                ...
                plt.plot(n+1,condnumber,''+str(cc)+'+')
            ...
            if n == run:
                ...
                plt.plot(n+1,condnumber,''+str(cc)+'o')
            ...
            if n == run:
                ...
                #l3, = plt.plot(n+1,condnumber,''+str(cc)+'x',label='Nens='+str(Nens)+'')
                 ...
                 plt.plot(n+1,condnumber,''+str(cc)+'x')
            #plt.plot(n+1,condnumber,'m.') 
            plt.yscale('log')
    ...
    plt.show()  # For plotting condition numbers, UNCOMMENT this line!!!
